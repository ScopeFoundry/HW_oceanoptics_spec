...
from .sdk_properties import oceandirect_dll # Modified ESB to relative imports
from .od_logger import od_logger # Modified ESB to relative imports
...
#        return errstr_cp.value.decode()
    ...
    def find_devices(self):
        ...
        try:
            ...
            sdk_data_json = json.dumps(exe_msg)
            logger.error(sdk_data_json)
        return self.usb_devices + self.tcpip_devices
...
class Spectrometer():
    ...
    class Advanced():
        ...
        def set_data_buffer_enable(self, enable):
            ...
            err_cp = (c_long * 1)(0)
            self.device.oceandirect.odapi_adv_set_data_buffer_enable(self.device.device_id, err_cp, enable)
        ...
        def get_usb_endpoint_primary_out(self):
            ...
            if err_cp[0] != 0:
                ...
                raise OceanDirectError(err_cp[0], error_msg)
            return usb_primary_endpoint_out
        ...
        def get_usb_endpoint_primary_in(self):
            ...
            if err_cp[0] != 0:
                ...
                raise OceanDirectError(err_cp[0], error_msg)
            return usb_primary_endpoint_in
        ...
        def get_usb_endpoint_secondary_out(self):
            ...
            if err_cp[0] != 0:
                ...
                raise OceanDirectError(err_cp[0], error_msg)
            return usb_secondary_endpoint_out
        ...
        def get_usb_endpoint_secondary_in(self):
            ...
            if err_cp[0] != 0:
                ...
                raise OceanDirectError(err_cp[0], error_msg)
            return usb_secondary_endpoint_in
        ...
        def ipv4_read_ip_address(self, ifNum, addressIndex, outIpAddress, outNetmask):
            ...
            @param[out] outIpAddress The ip address which is a list of 4 numbers.
            @param[out] outNetmask   The network mask of the ip address. Value range is from 0-32
            """
            err_cp        = (c_long * 1)(0)
            ...
            outNetmask = netmask_cp[0]
            for i in range(len(ip_address_cp)):
                outIpAddress.append(ip_address_cp[i])
